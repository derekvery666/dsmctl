...
| [WI-065](work-items/WI-065-certificate.md) | P1 | `proposed` | C | WI-006 | Certificate management: read installed certs/expiry/service bindings; guarded import (key via credential_ref), set-default, service-bind, delete (all high risk); Lets Encrypt issuance a non-goal. |
