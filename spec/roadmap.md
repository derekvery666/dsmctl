...
| [WI-043](work-items/WI-043-download-station.md) | P2 | `in_progress` | C | WI-019, WI-022 | Download Station module, package-gated on DownloadStation: reads (service config, task list, statistics, detailed settings), guarded task create/pause/resume/delete, and guarded group-dispatched settings writes (incl. auto-extraction and NZB partial sets) shipped + live-verified on 4.1.2. Remaining: task edit and NZB/extraction password changes. |
