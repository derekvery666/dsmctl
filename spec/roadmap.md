...
flowchart LR
  ...
  WI019["WI-019 Package Center"] --> WI021["WI-021 Package-scoped operations + Drive Admin"]
```
...
| [WI-014](work-items/WI-014-portable-gateway-daemon.md) | P0 | `in_progress` | F | - | Establish a platform-neutral, read-only Streamable HTTP gateway and hardened amd64 container. |
...
| [WI-021](work-items/WI-021-package-scoped-operations.md) | P1 | `in_progress` | C | WI-019 | Package-version-aware operation selection framework plus the read-only Drive Admin module. |
