...
- [gateway-connect-security-review.md](gateway-connect-security-review.md):
  2026-07-22 adversarial review record for the remote-MCP connect surface,
  including the verdict, controls that must not regress, product-policy notes,
  and verified gaps mapped to WI-096 through WI-099.
