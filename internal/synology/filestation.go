...
import (
	...
	filestationops "github.com/derekvery666/dsmctl/internal/synology/operations/filestation"
)
...
func (c *Client) FileStationCapabilities(ctx context.Context) (FileStationCapabilities, CompatibilityReport, error) {
	...
	capabilityNames := []string{
		...
		filestationops.ThumbCapabilityName,
	...
	capabilities := FileStationCapabilities{
		...
		Thumbnail:         supported(8),
		Upload:            supported(9),
		CreateFolder:      supported(10),
		Rename:            supported(11),
		Copy:              supported(12),
		Move:              supported(12),
		Delete:            supported(13),
		Compress:          supported(14),
		Extract:           supported(15),
		Favorite:          supported(16),
		Sharing:           supported(17),
		BackgroundTask:    supported(18),
	}
