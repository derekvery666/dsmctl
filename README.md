...
- `plan_download_station_settings_change`: validate a settings patch for exactly one group (BT, FTP/HTTP, RSS, location, scheduler, global, or auto-extraction) and return a state-bound approval plan without mutating DSM.
