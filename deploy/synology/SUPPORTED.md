...
The dsmctl/SPK release version is currently `7.3.2-24`: DSM compatibility train
7.3.2, dsmctl build 24. That managed-NAS compatibility label is separate from
